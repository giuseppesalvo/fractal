...
class NSButtonBordable: NSButton {
    ...
    func drawBorderTop(size: NSSize) {
        if borderTopSize < 1 { return }
        drawLine(
            from: NSPoint(x: 0, y: borderTopSize/2),
            to: NSPoint(x: size.width, y: borderTopSize/2),
    ...
    func drawBorderBottom(size: NSSize) {
        if borderBottomSize < 1 { return }
        drawLine(
            from: NSPoint(x: 0, y: size.height - borderBottomSize/2),
            to: NSPoint(x: size.width, y: size.height - borderBottomSize/2),
